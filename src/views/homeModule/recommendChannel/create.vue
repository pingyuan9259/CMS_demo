<template>
  <Box class="channel-box">
    <span slot="box-header">添加 推荐频道</span>
    <div slot="box-body">
      <!-- 频道列表 -->
      ...
      <div class="list-content">
        ...
        <el-button type="primary" class="channel-submit"  style="height: 40px;margin-right: 20px;margin-top: 10px;" @click.prevent="createRecommendChannel">提交</el-button>
      </div>
    ...
    methods: {
      ...
      async createRecommendChannel () {
        try {
          ...
          let result = await api.createRecommendChannel(this.reqOptions)
          this.logerrSuccess()
