<template>
  <Box class="article-box">
    <span slot="box-header">编辑 推荐文章</span>
    <div slot="box-body">
      <!-- 文章列表 -->
      <div class="app-container calendar-list-container">
        <div class="recommend-container">
          ...
          <!-- 顶部搜索 -->
         <el-input @keyup.enter.native="handleFilter" style="width: 150px;margin-top:20px;margin-left: 20px;" class="filter-item" placeholder="文章名" v-model="listQuery.title">
          </el-input>
          ...
          <!-- 表格 -->
          <el-table style="width: 100%;margin-top:10px;" :key='tableKey' :data="list" v-loading.body="listLoading" border fit highlight-current-row>
            ...
            <el-table-column min-width="150px" label="所在频道">
              <template scope="scope">
      ...
      <div class="list-content">
        ...
        <el-button type="primary" class="article-submit"  style="height: 40px;margin-right: 20px;margin-top: 10px;" @click.prevent="editRecommendArticle">提交</el-button>
      </div>
        ...
        try {
          ...
          for (let i = 0; i < this.recommendList.length; i++) {
            this.reqOptions.target_ids.push({
              ...
              'title': this.recommendList[i].title,
              'user_id': this.recommendList[i].userId
            })
          }
          let result = await api.editRecommendArticle(this.reqOptions)
          this.logerrSuccess()
          this.resetReqOptions()
          this.$router.replace({ path: './homeArticle'})
